    ...
    <div class="flex min-h-screen">
        ...
        >
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="{{ route('laraclaw.models.live') }}" class="{{ request()->routeIs('laraclaw.models.live') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700/50 hover:text-white' }} flex items-center gap-3 px-3 py-2 rounded-lg transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('laraclaw.benchmarks.live') }}" class="{{ request()->routeIs('laraclaw.benchmarks.live') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700/50 hover:text-white' }} flex items-center gap-3 px-3 py-2 rounded-lg transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 13h4v8H3v-8zm7-10h4v18h-4V3zm7 6h4v12h-4V9z"></path>
                    </svg>
                    Benchmarks
                </a>

                <a href="{{ route('laraclaw.providers.live') }}" class="{{ request()->routeIs('laraclaw.providers.live') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700/50 hover:text-white' }} flex items-center gap-3 px-3 py-2 rounded-lg transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
