...
Route::middleware('throttle:laraclaw-webhooks')->prefix('laraclaw/webhooks')->group(function () {
    ...
    Route::post('slack', SlackWebhookController::class)->name('laraclaw.webhooks.slack');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('laraclaw/live')->name('laraclaw.')->group(function () {
        ...
        Volt::route('/models', 'laraclaw.models')->name('models.live');
        Volt::route('/benchmarks', 'laraclaw.benchmarks')->name('benchmarks.live');
        Volt::route('/providers', 'laraclaw.providers')->name('providers.live');
    });
});
